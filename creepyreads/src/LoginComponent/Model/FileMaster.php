...
class FileMaster {
    ...
    static $usersFile = "src/LoginComponent/Model/users.txt";
    static $usersPassFile = "src/LoginComponent/Model/usersPass.txt";
    static $TimestampFile = "src/LoginComponent/Model/usersCookieTimestamp.txt";
